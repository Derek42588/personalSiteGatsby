...
export default ({ data, pageContext }) => {
  ...
  return (
    <Layout>
      <div className="Blog">
        <h1 className="Blog__title italics">Code Every Day</h1>

        <h4 className="Blog__postCount">
      ...
      <div className="BlogFooter">
        {!isFirstPage && (
          <Link to={prevPage} rel="prev" className="BlogFooter__item">
            Prev Page
          </Link>
        )}
        {` `}
        {Array.from({ length: totalPages }, (_, index) => (
          <Link
            ...
            className="BlogFooter__item"
          >
            {index + 1}
          </Link>
        ))}
        {!isLastPage && (
          <Link to={nextPage} rel="next" className="BlogFooter__item">
            Next Page
          </Link>
        )}
      </div>
